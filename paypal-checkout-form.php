...
<form id="s2member-pro-paypal-checkout-form" class="s2member-form s2member-pro-paypal-form s2member-pro-paypal-checkout-form" method="post" action="%%action%%" autocomplete="off">
	...
	<div id="s2member-pro-paypal-checkout-form-options-section" class="s2member-pro-paypal-form-section s2member-pro-paypal-checkout-form-section s2member-pro-paypal-form-options-section s2member-pro-paypal-checkout-form-options-section">
		<div id="s2member-pro-paypal-checkout-form-options-section-title" class="s2member-form-section-title s2member-pro-paypal-form-section-title s2member-pro-paypal-checkout-form-section-title s2member-pro-paypal-form-options-section-title s2member-pro-paypal-checkout-form-options-section-title">
	...
	<div class="column-left">
		<div id="s2member-pro-paypal-checkout-form-registration-section" class="s2member-pro-paypal-form-section s2member-pro-paypal-checkout-form-section s2member-pro-paypal-form-registration-section s2member-pro-paypal-checkout-form-registration-section">
			<div id="s2member-pro-paypal-checkout-form-registration-section-title" class="s2member-form-section-title s2member-pro-paypal-form-section-title s2member-pro-paypal-checkout-form-section-title s2member-pro-paypal-form-registration-section-title s2member-pro-paypal-checkout-form-registration-section-title">
	...
	<div class="column-right">
		...
		<div id="s2member-pro-paypal-checkout-form-billing-method-section" class="s2member-pro-paypal-form-section s2member-pro-paypal-checkout-form-section s2member-pro-paypal-form-billing-method-section s2member-pro-paypal-checkout-form-billing-method-section">
			<div id="s2member-pro-paypal-checkout-form-billing-method-section-title" class="s2member-form-section-title s2member-pro-paypal-form-section-title s2member-pro-paypal-checkout-form-section-title s2member-pro-paypal-form-billing-method-section-title s2member-pro-paypal-checkout-form-billing-method-section-title">
		...
		<div id="s2member-pro-paypal-checkout-form-billing-address-section" class="s2member-pro-paypal-form-section  s2member-pro-paypal-checkout-form-section s2member-pro-paypal-form-billing-address-section s2member-pro-paypal-checkout-form-billing-address-section">
			<div id="s2member-pro-paypal-checkout-form-billing-address-section-title" class="s2member-form-section-title s2member-pro-paypal-form-section-title s2member-pro-paypal-checkout-form-section-title s2member-pro-paypal-form-billing-address-section-title s2member-pro-paypal-checkout-form-billing-address-section-title">
		...
		<div id="s2member-pro-paypal-checkout-form-submission-section" class="s2member-pro-paypal-form-section s2member-pro-paypal-checkout-form-section s2member-pro-paypal-form-submission-section s2member-pro-paypal-checkout-form-submission-section">
			<div id="s2member-pro-paypal-checkout-form-submission-section-title" class="s2member-form-section-title s2member-pro-paypal-form-section-title s2member-pro-paypal-checkout-form-section-title s2member-pro-paypal-checkout-form-submission-section-title">
